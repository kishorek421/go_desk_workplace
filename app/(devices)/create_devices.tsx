...
const CreateAsset = () => {
  ...
  const [extendedWarrantyDate, setExtendedWarrantyDate] = useState<Date | null>(null);
  const [isLoading, setIsLoading] = useState(false);
  
  const [raiseAssetModel, setRaiseAssetModel] = useState<AssetMasterListItemModel>({
    asWarranty: false,
  });
  ...
  const [selectedLicensedType, setSelectedLicensedType] = useState<DropdownModel>();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append('oemWarrantyDate', oemWarrantyDate ? oemWarrantyDate.toISOString() : '');
      formData.append('extendedWarrantyDate', extendedWarrantyDate ? extendedWarrantyDate.toISOString() : '');
  ...
  const renderFormItem = ({ item }: { item: string }) => {
    switch (item) {
          ...
          <View className="p-4 mt-8 ">
            <FormControl>
              <FormControlLabel className="mb-1">
                <FormControlLabelText>{item.replace(/([A-Z])/g, ' $1')}</FormControlLabelText>
              </FormControlLabel>
              <Input variant="outline" size="md">
                <InputField
                  className="text-sm h-8"
                  placeholder=""
                  onChangeText={(text) => setRaiseAssetModel(prev => ({ ...prev, [item]: text }))} // Update here
                />
              </Input>
            </FormControl>
          </View>
      ...
      case "uniqueIdentifierType":
        return (
          <View className="p-4">
            <FormControl isInvalid={errors.some(e => e.field === "uniqueIdentifierType")}>
              <FormControlLabel className="mb-1">
                <FormControlLabelText>Unique Identifier Type</FormControlLabelText>
              </FormControlLabel>
              <CustomSelect
                options={assetTypes}
                selectedValue={selectedAssetType}
                placeholder=""
                onChange={(value) => setSelectedAssetType(value as DropdownModel)}
                type="assetType"
              />
              <FormControlError>
                <FormControlErrorText>{errors.find(e => e.field === "uniqueIdentifierType")?.message}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "assetType":
        return (
          <View className="p-4">
            <FormControl isInvalid={errors.some(e => e.field === "assetType")}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{errors.find(e => e.field === "assetType")?.message}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "assetModel":
        return (
          <View className="p-4">
            <FormControl isInvalid={errors.some(e => e.field === "assetModel")}>
              <FormControlLabel className="mb-1">
              ...
              <CustomSelect
                ...
                placeholder=""
                onChange={(value) => setSelectedAssetModel(value as DropdownModel)}
                type="assetModel"
              />
              <FormControlError>
                <FormControlErrorText>{errors.find(e => e.field === "assetModel")?.message}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "licensedType":
        return (
          <View className="p-4">
            <FormControl isInvalid={errors.some(e => e.field === "licensedType")}>
              <FormControlLabel className="mb-1">
              ...
              <CustomSelect
                ...
                placeholder=""
                onChange={(value) => setSelectedLicensedType(value as DropdownModel)}
                type="licensedType"
              />
              <FormControlError>
                <FormControlErrorText>{errors.find(e => e.field === "licensedType")?.message}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
      ...
      case "impact":
        return (
          <View className="p-4">
            <FormControl isInvalid={errors.some(e => e.field === "impact")}>
              <FormControlLabel className="mb-1">
              ...
              />
              <FormControlError>
                <FormControlErrorText>{errors.find(e => e.field === "impact")?.message}</FormControlErrorText>
              </FormControlError>
            </FormControl>
          </View>
        );
        ...
        case "extendedWarrantyDate":
          return (
            <View className="p-4">        
              ...
              <View className="flex-row items-center p-3 border border-gray-300 rounded-md">             
              <Text className="flex-1 mr-64 text-gray-600">
              {extendedWarrantyDate ? extendedWarrantyDate.toDateString() : ""}
              </Text>
  ...
  return (
    <VStack className="flex-1 bg-white">
      <ScrollView>
        <FlatList
          data={["serialNo", "purchaseId", "uniqueIdentifier", "uniqueIdentifierType", "assetType", "assetModel", "licensedType", "impact", "oemWarrantyDate", "extendedWarrantyDate"]}
